...
const { addToCart, myCart, updateCartItem, removeCartItem, emptyCart } = require("../controllers/cartController");
...
router.delete("/emptycart", verifyJWT, authorize("customer"), emptyCart);
